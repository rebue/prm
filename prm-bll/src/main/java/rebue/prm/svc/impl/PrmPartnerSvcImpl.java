...
public class PrmPartnerSvcImpl extends MybatisBaseSvcImpl<PrmPartnerMo, java.lang.Long, PrmPartnerMapper> implements PrmPartnerSvc {
    ...
    public Ro addEx(PrmPartnerMo mo) {
        ...
        Ro ro = new Ro();
        if (StringUtils.isAnyBlank(mo.getPartnerName(), mo.getContact())) {
    ...
    public Ro modifyEx(PrmPartnerMo mo) {
        ...
        if (StringUtils.isAnyBlank(mo.getPartnerName(), mo.getContact()) || mo.getId() == null) {
